<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="公告" prop="gonggao">
          <el-input v-model="ruleForm.gonggao" 
              placeholder="公告" clearable  :readonly="ro.gonggao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="公告" prop="gonggao">
              <el-input v-model="ruleForm.gonggao" 
                placeholder="公告" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          	            if(o=='gonggao'){
            this.ruleForm.gonggao = obj[o];
	    this.ro.gonggao = true;
            continue;
          }
	            	            if(o=='leixing'){
