...
public class XingyetongjiController {
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,XingyetongjiEntity xingyetongji, HttpServletRequest request){
        EntityWrapper<XingyetongjiEntity> ew = new EntityWrapper<XingyetongjiEntity>();
		PageUtils page = xingyetongjiService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, xingyetongji), params), params));
        return R.ok().put("data", page);
    }
    ...
    public R list( XingyetongjiEntity xingyetongji){
       	EntityWrapper<XingyetongjiEntity> ew = new EntityWrapper<XingyetongjiEntity>();
      	ew.allEq(MPUtil.allEQMapPre( xingyetongji, "xingyetongji")); 
        return R.ok().put("data", xingyetongjiService.selectListView(ew));
    }
     ...
     */
    @RequestMapping("/save")
    public R save(@RequestBody XingyetongjiEntity xingyetongji, HttpServletRequest request){
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<XingyetongjiEntity> wrapper = new EntityWrapper<XingyetongjiEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = xingyetongjiService.selectCount(wrapper);
